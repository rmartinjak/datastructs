...
int main(int argc, char **argv) {
    ...
    int n_items, n_buckets, empty, one, gtone, max;
    double avg;
    ...
    do {
        ...
        switch (*input) {
            ...
            case 's':
                ...
                break;
            case 'n':
                ht_statistics(ht, &n_items, &n_buckets, &empty, &one, &gtone, &max, &avg);
                printf("items: %d\n", n_items);
                printf("buckets: %d\n", n_buckets);
                printf("empty buckets: %d\n", empty);
                printf("buckets with 1 item: %d\n", one);
                printf("buckets with >1 item: %d\n", gtone);
                printf("maximum bucket size: %d\n", max);
